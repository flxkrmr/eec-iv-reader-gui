    ...
    for (let i = 0; i < 4; i += 1) {
      ...
      switch(type) {
        ...
        case 0x19:
          ...
          break
        case 0x1A:
          liveData.bitmap0 = this.toHexString(word);
          break
        case 0x1B:
          liveData.bitmap1 = this.toHexString(word);
          break
        case 0x1C:
        ...
        case 0x2B:
          ...
          break
        case 0x2C:
          liveData.notUsed2C = this.toHexString(word);
          break  
        ...
        case 0x33:
          ...
          break
        case 0x34:
          liveData.notUsed34 = this.toHexString(word);
          break
